...
const dotLottieWasmConfig = {
  module_or_path: `https://cdn.jsdelivr.net/npm/@lottiefiles/dotlottie-web@${DOTLOTTIE_WEB_WASM_VERSION}/dist/dotlottie-player.wasm`,
} as const;
...
setDotLottieWasmUrl(dotLottieWasmConfig as unknown as Parameters<typeof setDotLottieWasmUrl>[0]);
